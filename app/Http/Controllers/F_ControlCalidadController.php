...
class F_ControlCalidadController extends Controller
{
    /**
    ...
    {
        $query = F_F_ControlCalidad::with(['ordenProduccion.peticion', 'ordenProduccion.sku', 'inspector', 'reparaciones']);
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $control = F_ControlCalidad::create($validated);
     ...
     */
    public function estadisticasPorOrden(F_OrdenProduccion $ordenProduccion): JsonResponse
    {
    ...
    {
        $controles = F_ControlCalidad::with(['ordenProduccion.sku'])
    ...
    public function reporteCalidad(Request $request): JsonResponse
    {
        ...
        $controles = F_ControlCalidad::with(['ordenProduccion.sku', 'inspector'])
